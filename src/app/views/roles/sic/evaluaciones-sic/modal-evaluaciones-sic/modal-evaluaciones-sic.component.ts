...
@Component({
  selector: 'app-modal-evaluaciones-sic',
  templateUrl: './modal-evaluaciones-sic.component.html',
  styleUrl: './modal-evaluaciones-sic.component.scss'
})
export class ModalEvaluacionesSicComponent {
