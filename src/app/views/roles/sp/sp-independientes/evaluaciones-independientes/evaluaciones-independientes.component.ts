...
@Component({
  selector: 'app-evaluaciones-independientes',
  templateUrl: './evaluaciones-independientes.component.html',
  styleUrl: './evaluaciones-independientes.component.scss'
})
export class EvaluacionesIndependientesComponent {
