...
import { CriterioPam } from '../../../../models/Pamec/criteriopam.dto';
import { BsModalRef, BsModalService } from 'ngx-bootstrap/modal';
import { CriteriopamService } from '../../../../services/Pamec/criteriopam.service';
import { SharedServiceService } from '../../../../services/shared-service.service';
import { ActividadService } from '../../../../services/Pamec/actividad.service';

@Component({
  selector: 'app-evaluacion-pamec',
  templateUrl: './evaluacion-pamec.component.html',
  styleUrl: './evaluacion-pamec.component.scss'
})
export class EvaluacionPamecComponent {
  ...
  ngOnDestroy() {
    ...
    this.cri_pam_id = null as unknown as number;
    this.eva_pam_id = null as unknown as number
  }
