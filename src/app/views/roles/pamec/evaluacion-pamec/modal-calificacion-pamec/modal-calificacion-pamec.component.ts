...
import { CalificacionPamecService } from '../../../../../services/Pamec/calificacion-pamec.service';
...
@Component({
  ...
  styleUrl: './modal-calificacion-pamec.component.scss'
})
export class ModalCalificacionPamecComponent {


  calificacionPamec!: CalificacionPamecDto;
  cal_nota!: number;
  cal_aplica!: string;
  ...
  calificacionNoAplica(): void {
    ...
    this.cal_nota = null as unknown as number;
